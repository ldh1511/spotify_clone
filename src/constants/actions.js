...
export const OPEN_TRACK_MENU = "OPEN_TRACK_MENU";
export const CLOSE_TRACK_MENU = "CLOSE_TRACK_MENU";

export const SAVE_TRACKS = "SAVE_TRACKS";
export const SAVE_TRACKS_SUCCESS = "SAVE_TRACKS_SUCCESS";
export const SAVE_TRACKS_FAILED = "SAVE_TRACKS_FAILED";

export const REMOVE_FROM_TRACKS = "REMOVE_FROM_TRACKS";
export const REMOVE_FROM_TRACKS_SUCCESS = "REMOVE_FROM_TRACKS_SUCCESS";
export const REMOVE_FROM_TRACKS_FAILED = "REMOVE_FROM_TRACKS_FAILED";

export const REMOVE_ITEM_FROM_PLAYLIST = "REMOVE_ITEM_FROM_PLAYLIST";
export const REMOVE_ITEM_FROM_PLAYLIST_SUCCESS = "REMOVE_ITEM_FROM_PLAYLIST_SUCCESS";
export const REMOVE_ITEM_FROM_PLAYLIST_FAILED = "REMOVE_ITEM_FROM_PLAYLIST_FAILED";

export const GET_A_SHOW = "GET_A_SHOW";
