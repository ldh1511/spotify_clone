...
FooterSidebar.defaultProps = {
    items: []
}
function FooterSidebar(props) {
    ...
    return (
        <div className="footer-sidebar">
            <ul className="footer-sidebar-list top">
                <li>
                    <NavLink to="/">
                ...
                <li onClick={() => handleCreatePlaylist()}>
                    <p>
                        <svg role="img" height="12" width="12" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 fIDrcz">
